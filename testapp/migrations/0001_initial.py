    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('enc_char_field', encrypted_model_fields.fields.EncryptedCharField(max_length=396)),
                ('enc_text_field', encrypted_model_fields.fields.EncryptedTextField()),
                ('enc_date_field', encrypted_model_fields.fields.EncryptedDateField(max_length=100, null=True)),
                ('enc_date_now_field', encrypted_model_fields.fields.EncryptedDateField(auto_now=True, max_length=100, null=True)),
